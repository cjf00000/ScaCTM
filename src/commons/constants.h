...
//pseudo-randomly
static const uint16_t NUM_RNGS = 128;

//Used as the mask instead of mod operator
static const uint16_t RNG_MASK = (1 << 7) - 1;
...
//this is expected
static const uint32_t WARN_MEMORY_SIZE = 1u << 31;
...
static const std::string stopwords[1] = {"youwillneverfindthiswordinrealworldcorpus"};
...
static const uint16_t NUM_STP_WRDS = 1;
